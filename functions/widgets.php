...
$this->WP_Widget( 'pixel_text_widget', __('Pixel Text Widget', 'pts'), $widget_ops, $control_ops );
}
...
?>
		...
		<p><input id="<?php echo $this->get_field_id('filter'); ?>" name="<?php echo $this->get_field_name('filter'); ?>" type="checkbox" <?php checked(isset($instance['filter']) ? $instance['filter'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id('filter'); ?>"><?php _e('Automatically add paragraphs','pts'); ?></label></p>
<?php
	}
}
...
<p><input id="<?php echo $this->get_field_id('filter'); ?>" name="<?php echo $this->get_field_name('filter'); ?>" type="checkbox" <?php checked($instance['filter']); ?> /> <label for="<<?php echo $this->get_field_id('filter'); ?>"><?php _e('Automatically add paragraphs.','pts'); ?></label></p>
