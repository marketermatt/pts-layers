...
require_once ($includes_path . 'pre.php');

// Add a text domain
add_action('init', 'layers_theme_setup');
function layers_theme_setup()
{
    load_theme_textdomain('pts', get_template_directory() . '/languages');
}

function layers_enqueue() {
    wp_enqueue_style( 'themestyle', get_stylesheet_uri() );
    wp_enqueue_script( 's3Slider',get_template_directory_uri() . '/js/s3slider/s3Slider.js',array('jquery'),'1.0');
    wp_enqueue_script( 'kwicks',get_template_directory_uri() . '/js/kwicks/jquery.kwicks-1.5.1.js',array('jquery'),'1.0');
    wp_enqueue_script( 'jquery-easing',get_template_directory_uri() . '/js/kwicks/jquery.easing.1.3.js',array('jquery'),'1.0');
    wp_enqueue_style( 'themestyle', get_stylesheet_uri() );
}
add_action( 'wp_enqueue_scripts', 'layers_enqueue' );
...
array(  "type" => "open"),
	...
	array(  "name" => "Custom Logo",
		"desc" => __('Path to your logo image (Best to keep it within 250px x 100px or less).','pts'),
		"id" => $shortname."_logo",
		"std" => "",
		"type" => "text"),
	...
	array(  "name" => "Single Page Layout",
		"desc" => __('Choose your Single Post layout. Although you do not have to match it with the blog layout, if you use full width images, it is recommended to match this layout with the blog.','pts'),
...
array( "type" => "close"),	
array(  "name" => __('Style &amp; Colour Settings','pts'),
	"type" => "section"),
array(  "type" => "open"),

	array(  "name" => "Page Background",
		"desc" => __('Change your background style with pre-styled gradients or select None if you want just a colour background only (choose your background colour below).','pts'),
	...
	array(  "name" => "Background Colour",
		"desc" => __('Choose your own background colour after you select the gradient option above as None. Default colour is 293A47','pts'),
		"id" => $shortname."_bgcolour",
		"type" => "text_colour",
		"std" => "293A47"),
		
	array(  "name" => "Header Background",
		"desc" => __('Change your Header (behind the site title and Showcase) style with pre-styled gradients or select None if you want just a colour background only (choose your background below).','pts'),
	...
	array(  "name" => "Header Colour",
		"desc" => __('Choose your own Header background colour after you select the header gradient option above as None. Default colour is 293A47','pts'),
		"id" => $shortname."_headercolour",
		"type" => "text_colour",
		"std" => "293A47"),
		
	array(  "name" => "Site Title",
		"desc" => __('Choose the colour of your blog title. Default is white FFFFFF','pts'),
		"id" => $shortname."_blogtitle",
		"type" => "text_colour",
		"std" => "FFFFFF"),
		
	array(  "name" => "Site Caption",
		"desc" => __('Choose the colour of your blog description caption. Default is grey 7E7E7E','pts'),
		"id" => $shortname."_blogcaption",
		"type" => "text_colour",
		"std" => "7E7E7E"),
	
	array(  "name" => "Showcase Background Colour",
		"desc" => __('Choose the background colour for your showcase. Default colour is grey 444444','pts'),
		"id" => $shortname."_sccolour",
		"type" => "text_colour",
		"std" => "444444"),
	
	array(  "name" => "Outer Background Colour",
		"desc" => __('This is the outer container for your page content. Default colour is grey 838383','pts'),
		"id" => $shortname."_outer",
		"type" => "text_colour",
		"std" => "838383"),
		
	array(  "name" => "Main Menu Colour",
		"desc" => __('The main menu link colour. Default colour is dark 333333','pts'),
		"id" => $shortname."_menulink",
		"type" => "text_colour",
		"std" => "333333"),
	
	array(  "name" => "Main Menu Hover",
		"desc" => __('The main menu colour when you mouseover and active state. Default is 3C5C75','pts'),
		"id" => $shortname."_menuhlink",
		"type" => "text_colour",
		"std" => "3C5C75"),
		
	array(  "name" => "Page Links Colour",
		"desc" => __('Choose the colour of your in-page text links. Default is 446278','pts'),
		"id" => $shortname."_linkcolour",
		"type" => "text_colour",
		"std" => "446278"),
	
	array(  "name" => "Page Link Hover",
		"desc" => __('Choose the colour of your in-page text link hover colour on mouseovers. Default is 333333','pts'),
...
array(  "type" => "open"),
	...
	array(  "name" => "Home Page Showcase",
		"desc" => __('Choose any of the choices listed in the dropdown for your front page Showcase. The Showcase Widget can be used on other pages.','pts'),
	...
	array(  "name" => "Accordion Height",
		"desc" => __('Set the height of your Showcase Accordion group. Maximum height is 420 pixels.','pts'),
		"id" => $shortname."_accheight",
		"type" => "text",
		"std" => "420"),
		
	array(  "name" => "Accordion Width",
		"desc" => __('Set the width of your Showcase Accordion group images in their normal state (before mouseover). Default 4 image panel is 240 pixels and is done by dividing 960 pixels (full width) by the number of images.','pts'),
		"id" => $shortname."_accwidth",
		"type" => "text",
		"std" => "240"),
		
	array(  "name" => "Slideshow Height",
		"desc" => __('Set the height of your Showcase slideshow. Maximum dimensions are 960px x 420px for the Showcase area. I recommend you keep the 960px width.','pts'),
		"id" => $shortname."_ssheight",
		"type" => "text",
		"std" => "300"),
		
	array(  "name" => "Your Media Plugin Code",
		"desc" => __('Enter your own slideshow or other media plugin code for your own custom Showcase on the Front Page. Maximum dimensions are 960px x 420px for the Showcase area.','pts'),
...
array(  "type" => "open"),
	...
	array(  "name" => "Enable Image 1",
		"desc" => __('This disables or enables the first image.','pts'),
		"id" => $shortname."_pic1",
		"type" => "select",
		"std" => "Enable",
	...
	array(  "name" => "Image 1 Path",
		"desc" => __('The path where your image is located. Use either the Media Library or upload your images to a different location.','pts'),
		"id" => $shortname."_pic1path",
		"type" => "text",
		"std" => ""),
		
	array(  "name" => "Image 1 Link",
		"desc" => __('You can link this image to anything like a page, another website, or file with a full url.','pts'),
		"id" => $shortname."_pic1link",
		"type" => "text",
		"std" => ""),
	
	array(  "name" => "Image 1 Link Title",
		"desc" => __('For search engines and users, I recommend adding a title description if you use links.','pts'),
...
array(  "type" => "open"),
	...
	array(  "name" => "Enable Slide 1 Info",
		"desc" => __('This disables or enables the slide description and Read More link. You can disable this to just show the slide image only.','pts'),
	...
	array(  "name" => "Slide 1 ALT",
		"desc" => __('Add your slide image ALT description here.','pts'),
		"id" => $shortname."_s1alt",
		"type" => "text",
		"std" => ""),
		
	array(  "name" => "Slide 1 description",
		"desc" => __('Add your slide description content here for your slide being displayed.','pts'),
		"id" => $shortname."_s1desc",
		"type" => "textarea",
		"std" => ""),
	
	array(  "name" => "Slide 1 Link Text",
		"desc" => __('Choose what you want your (Read More) text to be for this slide.','pts'),
	...
	array(  "name" => "Slide 1 Link",
		"desc" => __('Add a link to what you want this slide to have. It can be to a page, post, image, file, website, or other.','pts'),
		"id" => $shortname."_s1link",
		"type" => "text",
		"std" => ""),
		
	array(  "name" => "Slide 1 Link Title",
		"desc" => __('Add a descriptive title for your link, which helps with search engine ranking.','pts'),
...
array(  "type" => "open"),
	...
	array(  "name" => "Copyright Information",
		...
		"std" => "Copyright &copy; 2014 All rights reserved. Theme by <a href='http://pixelthemestudio.ca' target='_blank'>Pixel Theme Studio.</a>",
		"type" => "textarea"),
...
die;
    ...
    if(function_exists('add_object_page'))
    {
		...
		$file_dir=get_template_directory_uri();
        add_theme_page($themename, $themename, 'administrator', basename(__FILE__), 'ptstheme_admin');
	}
	//add_submenu_page(basename(__FILE__), $themename, __('Theme Options','pts'), 'administrator', basename(__FILE__),'ptstheme_admin');
}
...
function layers_wp_title( $title, $sep ) {
    global $paged, $page;
...
add_filter( 'wp_title', 'layers_wp_title', 10, 2 );
...
add_theme_support('custom-background', $args); might not be needed since we already have the sliders and BGs running for site and do not need WP native header image. If you want to get rid of the message in theme check, uncomment this section*/
